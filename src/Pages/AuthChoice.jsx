    ...
    <div className="flex flex-col items-center justify-center min-h-screen text-gray-100 bg-gradient-to-br from-gray-900 to-gray-700">
      ...
      <div className="mt-6 w-full max-w-md space-y-4 px-4 sm:px-0">
        <div className="flex items-center justify-center">
          <span className="text-xs sm:text-sm text-gray-400">Or continue with</span>
        </div>
      ...
      <button
        type="button"
        className="w-full sm:w-auto relative flex items-center justify-center px-6 py-3 text-sm font-medium text-white-100 bg-transparent border border-gray-300 rounded-full overflow-hidden transition-all duration-300 group"
      >
        {/* Icon */}
        <svg
          className="w-5 h-5 mr-2 transition-all duration-300 group-hover:invert"
          viewBox="0 0 24 24"
        ...
        {/* Hover Effect */}
        <span
          className="absolute inset-0 rounded-full scale-0 group-hover:scale-100 transition-transform duration-300 ease-out opacity-40"
        ></span>
      </button>
      ...
      <button
        type="button"
        className="w-full sm:w-auto relative flex items-center justify-center px-6 py-3 text-sm font-medium text-white bg-transparent border border-gray-300 rounded-full overflow-hidden transition-all duration-300 group"
      >
        {/* Icon */}
        <svg
          className="w-5 h-5 mr-2 transition-all duration-300 group-hover:invert"

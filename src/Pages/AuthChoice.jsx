    ...
    <div className="flex flex-col items-center justify-center min-h-screen text-gray-100 bg-gradient-to-br from-gray-900 to-gray-700">
      ...
      <div className="mt-6 w-full max-w-md space-y-4 px-4 sm:px-0">
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
          ...
          <button
            type="button"
            className="w-full sm:w-auto flex items-center justify-center px-3 py-2 sm:px-6 sm:py-3 text-xs sm:text-sm font-medium text-gray-700 bg-white rounded-lg shadow-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 transition-all duration-300"
          >
            <svg

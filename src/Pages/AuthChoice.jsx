...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-gray-100 bg-gradient-to-br from-gray-900 to-gray-700">
      ...
      <button
        type="button"
        className="w-full sm:w-auto relative flex items-center justify-center px-6 py-3 text-sm font-medium text-white bg-black border-1 border-gray-300 group-hover:border-black rounded-full overflow-hidden transition-all duration-300 group"
      >
        {/* Icon */}
        <svg
          className="w-5 h-5 mr-2 transition-all duration-300 group-hover:invert relative z-10"
          viewBox="0 0 24 24"
        ...
        {/* Hover Effect */}
        <span
          className="absolute inset-0 rounded-full scale-0 group-hover:scale-100 transition-transform duration-300 ease-out group-hover:bg-white  group-hover:border-black z-0"
        ></span>
      </button>
      ...
      >
        ...
        {/* Hover Effect */}
        <span
          className="absolute inset-0 rounded-full scale-0 group-hover:scale-100 transition-transform duration-300 ease-out group-hover:bg-white z-0"
        ></span>
      </button>
        </div>
      </div>

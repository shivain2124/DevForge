...
//   return (
//     <div className="bg-gradient-to-br from-gray-900 to-gray-700 text-white py-20 min-h-screen">
//       {/* Hero Section */}
...
//             <p className="m-0 text-[clamp(2.5rem,7vw,4rem)] font-medium text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 leading-[1.1] whitespace-nowrap">
//               Welcome To
//             </p>
//             <h1 className="m-0 text-[clamp(3rem,10vw,5rem)] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600 leading-[1.2] whitespace-nowrap">
//               DevForge
//             </h1>
//             <p className="mt-9 text-[clamp(0.85rem,2.5vw,1rem)] text-gray-300">
...
//               className="px-4 py-2 rounded bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 w-full sm:w-auto flex-1"
//             />
//             {/* <button
//               onClick={handleRedirect}
//               className="w-full sm:w-auto px-4 sm:px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded text-sm sm:text-base whitespace-nowrap transition-all duration-300"
//             >
//               Sign Up
//             </button> */}
//             <LoginButton label="Sign Up" onClick={handleRedirect} />
//           </div>
//         </div>
...
//       {/* Horizontal Line */}
//       <hr className="mt-8 border-gray-700 w-3/4 md:w-1/2 mx-auto my-8" />
...
//         <div className="w-full md:w-1/2 flex flex-col gap-1.5">
//           <div className="text-center md:text-left">
//             <p className="m-0 text-[clamp(2.5rem,8vw,4rem)] font-medium text-white leading-none whitespace-nowrap">
//               Welcome To
//             </p>
